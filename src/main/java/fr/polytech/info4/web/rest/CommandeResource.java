...
import fr.polytech.info4.service.CommandeService;
...
/**
 * REST controller for managing {@link fr.polytech.info4.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
public class CommandeResource {
    ...
    public List<CommandeDTO> getAllCommandes(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
