...
public class TypeCommerceResourceIT {
    ...
    public void createTypeCommerce() throws Exception {
        ...
        TypeCommerceDTO typeCommerceDTO = typeCommerceMapper.toDto(typeCommerce);
        restTypeCommerceMockMvc.perform(post("/api/type-commerces")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typeCommerceDTO)))
    ...
    public void updateTypeCommerce() throws Exception {
        ...
        updatedTypeCommerce
            .nom(UPDATED_NOM);
        TypeCommerceDTO typeCommerceDTO = typeCommerceMapper.toDto(updatedTypeCommerce);
