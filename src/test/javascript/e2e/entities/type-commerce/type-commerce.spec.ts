...
describe('TypeCommerce e2e test', () => {
  ...
  it('should load TypeCommerces', async () => {
    ...
    expect(await typeCommerceComponentsPage.getTitle()).to.eq('myblogApp.typeCommerce.home.title');
    await browser.wait(
  ...
  it('should load create TypeCommerce page', async () => {
    ...
    expect(await typeCommerceUpdatePage.getPageTitle()).to.eq('myblogApp.typeCommerce.home.createOrEditLabel');
  ...
  it('should delete last TypeCommerce', async () => {
    ...
    expect(await typeCommerceDeleteDialog.getDialogTitle()).to.eq('myblogApp.typeCommerce.delete.question');
