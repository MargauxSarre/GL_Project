...
describe('Avis e2e test', () => {
  ...
  it('should load Avis', async () => {
    ...
    expect(await avisComponentsPage.getTitle()).to.eq('myblogApp.avis.home.title');
  ...
  it('should load create Avis page', async () => {
    ...
    expect(await avisUpdatePage.getPageTitle()).to.eq('myblogApp.avis.home.createOrEditLabel');
  ...
  it('should delete last Avis', async () => {
    ...
    expect(await avisDeleteDialog.getDialogTitle()).to.eq('myblogApp.avis.delete.question');
